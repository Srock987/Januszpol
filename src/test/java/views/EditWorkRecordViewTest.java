 ...
 */
public class EditWorkRecordViewTest extends ApplicationTest{
    ...
    public void start(Stage stage)
        ...
        ScreenManager
                .getInstance()
                .setScreen(ScreenManager.EDIT_WORK_RECORD_VIEW_ID);
    }

    @Test
    public void verifyLabelsText() {
        verifyThat(TITLE_WORKRECORD_LABEL, hasText("Edytuj czas pracy"));
